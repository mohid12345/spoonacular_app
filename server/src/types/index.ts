...
export interface IUserRepository { //for user service
  findByEmail(email: string): Promise<IUser | null>;
  create(user: Omit<IUser, '_id'>): Promise<IUser>;
  findById(id: string): Promise<IUser | null>;
}

export interface IRecipeRepository { //for recipe service
...
export interface IAuthService { //for user service
...
export interface IUserService { //for user controller
...
export interface IRecipeService { //for recipe controller
...
// Controller interfaces to keep routing loosely coupled
